            ...
            [
                dbc.Col(
                    [
                        dbc.Card(
                            [
                                dbc.CardImg(src=app.get_asset_url('3.jpg'), bottom=True),
                            ],
                        )
                    ] 
                )
                    ...
                    [
                        dbc.Card(
                            [
                                ...
                                dbc.CardImg(src=app.get_asset_url('5.jpg'), bottom=True),
                            ],
                        )
                    ] 
                )
                ...
                dbc.Col(
                    [
                        dbc.Card(
                            [
                                # dbc.CardBody(html.P("This has a bottom image", className="card-text")),
                                dbc.CardImg(src=app.get_asset_url('8.jpg'), bottom=True),
                            ],
                        )
                    ] 
                )
            ...
            [
                dbc.Col(
                    [
                        dbc.Card(
                            [
                                dbc.CardImg(src=app.get_asset_url('7.jpg'), bottom=True),
                            ],
                        )
                    ] 
                )
